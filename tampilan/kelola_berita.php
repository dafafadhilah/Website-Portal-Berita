...
<table width="100%" border="1" cellspacing="0" cellpadding="0">  
	<tr>    
		...
		<td width="5%" bgcolor="#CCCCCC">Foto By</td>  
	...
	while($berita=mysqli_fetch_array($query))
		{
			...
			<tr>    
				...
				<td><?php echo $berita['foto_by']; ?></td>    
				<td><?php echo tgl_ina2($berita['tgl_posting']); ?></td>   
				<td><?php echo $berita['dilihat']; ?></td>    
				<td><?php echo $jmlkomen; ?></td>    
				<td width="18%"><?php echo "<a href=admin.php?tampilan=edit_berita&id_berita=$berita[id_berita]> <button> Edit </button></a>"; ?></td>    
				<td width="18%"><?php echo "<a href=perintah/kelola_berita.php?aksi=hapus&id_berita=$berita[id_berita]> <button> Hapus </button></a>"; ?></td>  </tr>  <?php  $n++; }  ?>  
</table>