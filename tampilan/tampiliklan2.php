...
$query=mysqli_query($koneksi,"select*from iklan where aktif=1 and id_iklan=6"); //tampilkan iklan yg masih aktif yg tgl_awalnya dimulai dr skr
while($iklan=mysqli_fetch_array($query)){
	echo "<span class='iklan'>
	<a href='$iklan[link]'target='_BLANK'>
	<img src='gambar/$iklan[gambar]'width='115px'>
