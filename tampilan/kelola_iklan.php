...
while($iklan=mysqli_fetch_array($query)){?>  
	<tr>    
		...
		<td><?php echo "<img src=gambar/$iklan[gambar] width='100px'>"; ?></td>    
		<td><?php echo $iklan['email']; ?></td>    
		<td><?php echo $iklan['link']; ?></td>    
		<td><?php echo tgl_ina2($iklan['tgl_mulai']); ?></td>    
		<td><?php echo tgl_ina2($iklan['tgl_akhir']); ?></td>    
		...
		<td width="18%"><?php echo "<a href=admin.php?tampilan=edit_iklan&id_iklan=$iklan[id_iklan]> <button> Edit </button></a>"; ?></td>    
		<td width="18%"><?php echo "<a href=perintah/kelola_iklan.php?aksi=hapus&id_iklan=$iklan[id_iklan]> <button> Hapus </button></a>"; ?></td>  
		</tr>  <?php  $total=$total+$iklan['totalharga'];
	$n++; 
}  ?>  
<tr>    
